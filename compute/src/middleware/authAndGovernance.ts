...
export const PRICING_TIERS: Record<string, TierConfig> = {
  free: {
    ...
    vcpuRatePerHour: 0,
    allowedEndpoints: ['/v1/llm-costs', '/v1/model-benchmarks', '/v1/deprecations'],
  },
  starter: {
    id: 'starter',
    name: 'Starter',
    priceMonthly: 49,
    dataCredits: 5_000_000,
    computeCredits: 49.0,
    canUseCompute: true,
    rateLimitReqMin: 60,
    maxConcurrentSandboxes: 3,
    vcpuRatePerHour: 0.15,
    allowedEndpoints: ['*'],
  },
  growth: {
    id: 'growth',
